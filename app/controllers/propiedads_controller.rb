class PropiedadsController < ApplicationController
  ...
  private
    ...
    def propiedad_params
      params.require(:propiedad).permit(:tipo_operacion, :tipo_inmueble, :titulo, :subtitulo, :descripcion, :localizacion, :distrito, :direccion, :cod_postal, :precio_desde, :precio_hasta, :superficie_desde, :superficie_hasta, :estado, :ubicacion, :distrito, :dormitorios, :banos)
    end
end
